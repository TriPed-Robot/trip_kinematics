...
In both cases common practices can be observed which are reimplemented each time as reported by @survey .
...
​This approach models a parallel manipulator as a virtual serial manipulator and a mapping witch maps the virtual joint state to the true actuated joint state of the parallel manipulator.
